...
plot([1:length(features)]/length(features),feature_1,'DisplayName','1','MarkerSize',2,'Marker','.','LineWidth',1,...
    'Color',[0 0 0])
hold on
plot([1:length(features)]/length(features),feature_2,'DisplayName','2','MarkerSize',2,'Marker','.','LineWidth',1,...
    'Color',[1 0 0])

plot([1:length(features)]/length(features),smooth_fea1,'DisplayName','1-smooth','MarkerSize',2,'Marker','.','LineWidth',1,...
    'Color',[0 0 0])
hold on
plot([1:length(features)]/length(features),smooth_fea2,'DisplayName','2-smmoth','MarkerSize',2,'Marker','.','LineWidth',1,...
    'Color',[1 0 0])
hold on
